...
//
//std::chrono::duration<double> list_search_linear_rfctrd(struct list*&, const i32, bool&);
//inline bool list_search_lnr_rfctrd(struct list*&, const size_t, const i32);
//
//std::chrono::duration<double> list_search_guardian_rfctrd(struct list*&, const i32, bool&);
//inline bool list_search_grd_rfctrd(struct list*&, const size_t, const i32);
//
//std::chrono::duration<double> list_search_binary_rfctrd(struct list*&, const i32, bool&);
//inline bool list_search_bnr_rfctrd(struct list*&, size_t, size_t, const i32);
//
